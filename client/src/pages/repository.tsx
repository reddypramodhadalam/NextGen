...
// 🆕 NEW IMPORTS - Enhanced Step Editor
...
{/* 🆕 ENHANCED TEST CASE EDITOR - Replaces old dialog */}
{testCaseDialogOpen && (
...
await createTestCaseMutation.mutateAsync(testCase);
}
}}
...
return (
<Card key={suite.id} colorSeed={`repository-suite-${suite.id}`}>
<Accordion
type="multiple"
...
<Card colorSeed="repository-unassigned">
